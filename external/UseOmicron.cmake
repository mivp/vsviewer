set(USE_OMICRON true CACHE BOOL "When set to true, use omicron")

if(USE_OMICRON)
	set(OMICRON_BASE_DIR ${CMAKE_BINARY_DIR}/3rdparty/omicron)
	set(OMICRON_BINARY_DIR ${CMAKE_BINARY_DIR}/3rdparty/omicron/install)
	set(OMICRON_SOURCE_DIR ${CMAKE_BINARY_DIR}/3rdparty/omicron/source)

	ExternalProject_Add(
		omicron
		URL ${CMAKE_SOURCE_DIR}/external/omicron.tar.gz
		PREFIX omicron
		INSTALL_COMMAND ""
		DOWNLOAD_DIR ${OMICRON_BASE_DIR}
		...
		CMAKE_ARGS 
			...
			-DOMICRON_LIBRARY_OUTPUT_DIRECTORY:PATH=${CMAKE_BINARY_DIR}/bin
			-DOMICRON_ARCHIVE_OUTPUT_DIRECTORY:PATH=${CMAKE_BINARY_DIR}/bin
			-DOMICRON_RUNTIME_OUTPUT_DIRECTORY:PATH=${CMAKE_BINARY_DIR}/bin
